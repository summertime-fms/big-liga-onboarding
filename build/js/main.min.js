...
/* harmony import */ var _modules_init_loader__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-loader */ "./js/modules/init-loader.js");
/* harmony import */ var _modules_show_additional_info__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/show-additional-info */ "./js/modules/show-additional-info.js");
...
Object(_modules_init_loader__WEBPACK_IMPORTED_MODULE_3__["initLoader"])();
Object(_modules_show_additional_info__WEBPACK_IMPORTED_MODULE_4__["showMore"])();
...
/*!***********************************!*\
  !*** ./js/modules/init-loader.js ***!
  \***********************************/
/*! exports provided: initLoader */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initLoader", function() { return initLoader; });
var initLoader = function initLoader() {
  var desktopMinWidth = 1024;
  var loader = document.querySelector('.loader');
  var content = document.querySelector('.page-wrapper');
  var logo = loader.querySelector('.loader__image');

  var showContent = function showContent(evt) {
    if (window.matchMedia('(min-width:' + desktopMinWidth + 'px)').matches) {
      if (evt.key == 'Enter') {
        loader.classList.add('hidden');
        content.style.display = "block"; // window.removeEventListener('keydown', function(evt))
      }
    } else {
      loader.classList.add('hidden');
...
/***/ "./js/modules/show-additional-info.js":
/*!********************************************!*\
  !*** ./js/modules/show-additional-info.js ***!
  \********************************************/
